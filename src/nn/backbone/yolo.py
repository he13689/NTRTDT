...
from .common import Conv, Concat, C2f, SPPF, Conv8, SPDConv, WASPConv, ASDownSample, MP2, MP3, C3, ContextGuidedBlock_Down, ContextGuidedBlock, SCDown, C2fCIB, PSA, MP
...
class YOLOBackbone(nn.Module):
    def __init__(self, cfg, ch=None):
        ...
        for i, (f, n, m, args) in enumerate(self.cfg['backbone']):  # 创建backbone
            ...
            if m in [nn.Conv2d, Conv, ASDownSample, MP2, SPDConv, MP3, C3]:
